...
.. note:: 
   ...
   As a pre-requisite you must have already applied for your account credentials to access the KSL supercomputing resources. Please refer to a detailed guide on how to `get an account for KSL systems <https://hpc.kaust.edu.sa/content/apply-access>`_.  
